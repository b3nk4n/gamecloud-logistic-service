# GameCloud Logistic Service

This application is part of the GameCloud system and provides event driven (pseudo) logistics functionality for shipping of
video games ordered via [gamecloud-order](https://github.com/b3nk4n/gamecloud-order-service) service.
